...
/**
 * @brief Ordena um vetor de inteiros em ordem crescente usando o método Bolha.
 * * @param vetor O vetor de inteiros a ser ordenado.
 * @param quantidade O número de elementos no vetor que devem ser ordenados.
 */
void ordenar(int vetor[], int quantidade) {
